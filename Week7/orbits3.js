...
function registerName() {
    ...
    ticket.fName = document.getElementById("fname").value;  // Assigns fname field to the fName property of ticket
    ticket.lName = document.getElementById("lname").value;  // Assigns lname field to the lName property of ticket

    passengerName.innerHTML = ticket.fName + " " + ticket.lName;    // Assigns fName + lName to the passengerName element with a space inbetween
